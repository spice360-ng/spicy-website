...
const paragraphs = [
    "Each name is chosen to describe who the person is. The names are used in informal communications, on event badges, and in any context where warmth and personality belong. They are never used in contracts.",
